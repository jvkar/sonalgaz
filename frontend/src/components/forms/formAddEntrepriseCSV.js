...
const FormAddEntrepriseCSV = ({closeEvent}) => {
    ...
    return (
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
                <TextField id="NombreDesCoupures" value={NombreDesCoupures} type="number "onChange={(e)=>setNombreDesCoupures(e.target.value)} label="le nombre des coupures/ retablissement par entreprise " variant="outlined"  siz="small" sx={{minWidth:"100%"}}/>
            </Grid>
            <Grid item xs={6}>
