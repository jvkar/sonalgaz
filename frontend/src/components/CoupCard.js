...
export default function CoupCard({ coupure }) {
  ...
  const [etat, setEtat] = React.useState(coupure.etat);
  ...
  const validate = async (e) => {
    e.preventDefault();
    const response = await fetch(`/api/Clients/valider/${coupure._id}`, {
      method: "PATCH",
  ...
  const invalidate = async (e) => {
    e.preventDefault();
    const response = await fetch(`/api/Clients/invalider/${coupure._id}`, {
      method: "PATCH",
